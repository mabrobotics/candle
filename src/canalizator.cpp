...
Canalizator::Canalizator()
{

}

Canalizator::Canalizator(std::string canalizatorDev, int baudrate = 115200, int canBaudrate = 1000000)
{
 ...
 */
int Canalizator::transmitAndReceive()
{
...
bool Canalizator::setRxTimeout(int timeoutMs)
{
...
bool Canalizator::setCanSpeed(int canBaud)
{
...
bool Canalizator::setMsgLen(int newMsgLen)
{
...
void Canalizator::setCanTx(const char* data, int len)
{
    if(len > 0 || len < 64)
...
int Canalizator::getCanRx(char * rxData)
{
    if (receivedBytes > 0)
