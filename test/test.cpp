...
class MockSpiDevice : public mab::Bus
{
   public:
	...
	MOCK_METHOD(bool, receive, (int timeoutMs, bool checkCrc, bool faultVerbose), (override));
	MOCK_METHOD(int, getBytesReceived, (), (override));
...
TEST(TestCandle, test_contructor)
{
	...
	mab::Candle candle(mab::CAN_BAUD_1M, true, mab::CANdleFastMode_E::NORMAL, true, spiDeviceM);
